<?php
	class plugin_kontakt_install {
		function install() {
			...
			$wpdb->query("INSERT INTO `" . $wpdb->prefix . "kontakt_options` (`name`, `value`) VALUES ('BUTTON_RESET_NAME', 'Eingabe Leeren')");
			$wpdb->query("INSERT INTO `" . $wpdb->prefix . "kontakt_options` (`name`, `value`) VALUES ('BUTTON_SEND_NAME', 'Versenden')");
			...
			$wpdb->query("INSERT INTO `" . $wpdb->prefix . "kontakt_options` (`name`, `value`) VALUES ('HTML_TEXT', 'Herzlich Willkommen.')");
